...
define(function() {
    ...
    return {
        ...
        ADD_GUI_ELEMENT:{type:'ADD_GUI_ELEMENT', args:{data:{}}},
      	REMOVE_GUI_ELEMENT:{type:'REMOVE_GUI_ELEMENT', args:{data:{}}},
        ...
        WATER_EFFECT:{type:'WATER_EFFECT', args:{}},
        ...
        QUIT_ACTIVE_LEVEL:{type:'QUIT_ACTIVE_LEVEL', args:{}}
    }
});
